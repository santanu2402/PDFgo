...
import { ppttopdf } from '../api/ApiCalls';
...
const PptToPdfScreen = (props: any) => {
    ...
    const convertToPdf = async () => {
        if (!fileUri) {
            Alert.alert('No File Selected', 'Please select a PPT/PPTX file first.');
            return;
        }
        ...
        try {
            ...
            const response = await ppttopdf(fileName, fileContent);
            ...
            fileReaderInstance.onload = async () => {
                ...
                const path = `/storage/emulated/0/Download/PDFgo/PowerpointToPdf/${fileName}_converted.pdf`;
